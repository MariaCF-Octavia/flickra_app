...
const Login = () => {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      const userPlan = user.user_metadata?.plan?.toLowerCase() || 'basic';
      ...
      if (userPlan === 'pro') {
        console.warn("Legacy 'pro' plan detected - consider migrating to 'enterprise'");
        // You might want to add automatic migration logic here
      }
